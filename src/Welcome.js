                    ...
                    <div className="content">
                        <div className="container d-flex-column align-items-center justify-content-center" style={{width: "100%", height: "100%", overflow: "hidden"}}>
                            <div className="row mt-4">
                                <h1 data-aos="fade-down" data-aos-delay="500" data-aos-duration="2000" className="font-esthetic text-secondary fs5">The Wedding Of</h1>
                            ...
                            <div className="row">
                                <div className="col-md-12 col-md-offset-2 text-center fh5co-heading">
                                    <h1 data-aos="fade-up" data-aos-delay="1000" data-aos-duration="2000" className='font-esthetic text-secondary my-2' style={{fontSize: "3.2em"}}>Novi & Dika</h1>
